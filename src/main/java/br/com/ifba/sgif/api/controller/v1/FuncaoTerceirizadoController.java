...
import br.com.ifba.sgif.api.entity.funcaoterceirizado.service.IServiceFuncaoTerceirizado;
 ...
 * @since V1.0.1
 *
 * Veja também: {@link FuncaoTerceirizado}
 */
...
public class FuncaoTerceirizadoController {
    ...
    public ResponseEntity<?> deletarFuncaoTerceirizadoPorID(@Valid @PathVariable("id") @NotNull Long id) {

...
import br.com.ifba.sgif.api.entity.tipoturma.service.IServiceTipoTurma;
...
public class TipoTurmaController {
    ...
    public ResponseEntity<?> deletarTipoTurmaPorID(@Valid @PathVariable("id") @NotNull Long id) {
